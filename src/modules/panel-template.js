...
function buildUpdateIntervalOptionsHtml() {
...
function buildUpdatePaneHtml() {
  return `
    <div class="pane-card">
        <div class="setting-item">
            <span class="setting-item-label">自动检测更新</span>
            <select id="ld-update-interval" class="update-interval-select">${buildUpdateIntervalOptionsHtml()}</select>
        </div>
    </div>
    <div class="pane-card update-check-card">
        <div class="setting-item">
            <span class="setting-item-label">手动检测更新</span>
            <button id="ld-check-updates" class="webdav-btn restore-btn update-check-btn">立即检测</button>
        </div>
...
export function buildPanelHtml() {
  return `
    ...
    <div class="panel-body"><div class="panel-sidebar"><ul>
        <li data-tab="blocking" class="active">屏蔽功能</li><li data-tab="removal">功能开关</li><li data-tab="sync">云端同步</li><li data-tab="update">版本检测</li>
        ...
        <div class="content-pane" data-pane="update">
            <div class="update-version-info">当前版本 v${SCRIPT_VERSION}</div>
            ${buildUpdatePaneHtml()}
        </div>
    </div></div>`;
}
